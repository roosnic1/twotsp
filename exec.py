...
def doSolve(anzpoints,algo, filename=False):
    print "*** Step 1: *** \t\t\t ***"
    ...
    if not readdump:
        ...
        if algo == 'evo' or algo == 'acs' or algo == 'me':
...
if __name__ == '__main__':
    #ecex < 1s
    print "*********** 10 Staedte evo *******************************************************************"
    doSolve(10,'evo')
    #ecex < 1s
    print "*********** 10 Staedte acs *******************************************************************"
    doSolve(10,'acs')
    #ecex < 1s
    print "*********** 10 Staedte me ********************************************************************"
    doSolve(10,'me')
    #ecex < 1s
    print "*********** 10 Staedte njm *******************************************************************"
    doSolve(10,'njm')

    #ecex ~4s
    print "*********** 80 Staedte evo *******************************************************************"
    doSolve(80,'evo')
    #ecex ~45s
    print "*********** 80 Staedte evo *******************************************************************"
    doSolve(80,'acs')
    ...
    #exec ~40s
    print "*********** 500 Staedte evo ******************************************************************"
    doSolve(500,'evo')
    #exec ~3s
    print "*********** 500 Staedte njm ******************************************************************"
    doSolve(500,'njm')

    #exec ~40s
    print "*********** 1500 Staedte njm *****************************************************************"
    doSolve(1500,'njm')

    #exec ~75min
    print "*********** 15000 Staedte njm *****************************************************************"
    doSolve(15000,'njm')
